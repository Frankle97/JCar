...
public class PagingDto_Rev {
	...
	public PagingDto_Rev() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public PagingDto_Rev(int pageTotal, int onepageLimit, int pageAll, int pstartno, int bottomList, int bottom_current,
			int bottom_start, int bottom_end, ArrayList<ReviewDto> list) {
		super();
