...
<form action="<%=request.getContextPath()%>/addListFinal_Admin.do" method="post" id="act" enctype="multipart/form-data">
<fieldset>
<legend><strong>차량 등록</strong></legend>
<div class="form-group">
<label for="writer">판매자</label>
<input type="text" id="writer" class="form-control" value="관리자">
</div>
<div class="form-group">
<label for="country">색상</label>
...
<input type="text" name="birth" id="birth" class="form-control" placeholder="숫자 네자리로 입력해주세요 예시)1904 -> 19년04월식">
</div>
<div class="form-group">
